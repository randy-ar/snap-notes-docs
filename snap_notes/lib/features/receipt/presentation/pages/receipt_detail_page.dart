...
class ReceiptDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<ReceiptDetailCubit>()..fetchReceiptDetail(receiptId),
      child: const ReceiptDetailView(),
    );
  }
}
...
class ReceiptDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: BlocBuilder<ReceiptDetailCubit, ReceiptDetailState>(
        builder: (context, state) {
          if (state is ReceiptDetailLoading) {
            return const Center(child: CircularProgressIndicator());
          } else if (state is ReceiptDetailError) {
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  PrimaryButton(
                    onPressed: () {
                      // The id is not easily accessible here without passing it, 
                      // but we can just use the initial one from the page.
                      // Or simply we don't handle retry here for simplicity.
                    },
          ...
          } else if (state is ReceiptDetailLoaded) {
