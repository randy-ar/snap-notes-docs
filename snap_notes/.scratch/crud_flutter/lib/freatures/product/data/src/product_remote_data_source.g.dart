...
class _ProductRemoteDataSource implements ProductRemoteDataSource {
  ...
  Future<ProductListResponseModel> getProducts() async {
    ...
    final _options = _setStreamType<ProductListResponseModel>(
  ...
  Future<ProductSingleResponseModel> createProduct({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductSingleResponseModel _value;
    try {
      _value = ProductSingleResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ProductDeleteResponseModel> deleteProduct(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProductDeleteResponseModel>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductDeleteResponseModel _value;
    try {
      _value = ProductDeleteResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
