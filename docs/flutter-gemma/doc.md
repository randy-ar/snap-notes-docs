# flutter_gemma | Flutter package

[![CI Tests](https://external-images.pub.dev/WKEP01x2wRyYII9QUiX2ltP5fAqziwTlg699LOwAo04%3D/1783209600000/https%3A%2F%2Fgithub.com%2FDenisovAV%2Fflutter_gemma%2Factions%2Fworkflows%2Ftest.yml%2Fbadge.svg)](https://github.com/DenisovAV/flutter_gemma/actions/workflows/test.yml) [![Release Build](https://external-images.pub.dev/m6PzuwgSof4JsAYkH18OCr%2F2Z7Y%2BL3fSjhPJ7O%2BPVUM%3D/1783209600000/https%3A%2F%2Fgithub.com%2FDenisovAV%2Fflutter_gemma%2Factions%2Fworkflows%2Frelease.yml%2Fbadge.svg)](https://github.com/DenisovAV/flutter_gemma/actions/workflows/release.yml) [![pub package](https://external-images.pub.dev/AS9VI4TMZIZO9pZY8MKG8oUA4eKe%2FIWvskVNBCF0MXU%3D/1783209600000/https%3A%2F%2Fimg.shields.io%2Fpub%2Fv%2Fflutter_gemma.svg)](https://pub.dev/packages/flutter_gemma) [![Ask DeepWiki](https://external-images.pub.dev/c7ZeoKOfN9hpwTfbQJksu0bRKR8WPUpSz6W4QcJiNGE%3D/1783209600000/https%3A%2F%2Fdeepwiki.com%2Fbadge.svg)](https://deepwiki.com/DenisovAV/flutter_gemma)

[![ko-fi](https://external-images.pub.dev/hk8LcQnpok%2Bfxi21sGql%2Buy0XtvIt%2ByxPadgQc5qpqc%3D/1783209600000/https%3A%2F%2Fko-fi.com%2Fimg%2Fgithubbutton_sm.svg)](https://ko-fi.com/flutter_gemma)
...
![gemma_github_cover](https://external-images.pub.dev/SFBjllBeR6Q6aedBy5idVDuVf0XY3K%2FlT0EY7F8me4U%3D/1783209600000/https%3A%2F%2Fraw.githubusercontent.com%2FDenisovAV%2Fflutter_gemma%2Fmain%2Fpackages%2Fflutter_gemma%2Fassets%2Fgemma3.png)
...
![gemma_github_gif](https://external-images.pub.dev/9x8b3g%2FldQHk9M48sl92qs91InUIc%2BUX0dpnXgn115g%3D/1783209600000/https%3A%2F%2Fraw.githubusercontent.com%2FDenisovAV%2Fflutter_gemma%2Fmain%2Fpackages%2Fflutter_gemma%2Fassets%2Fgemma.gif)
...
- **🖥️ Desktop Support:** Native desktop apps (macOS, Windows, Linux) with GPU acceleration via LiteRT-LM, called directly from Dart through `dart:ffi` — no JVM/JRE bundling. See [DESKTOP_SUPPORT.md](https://github.com/DenisovAV/flutter_gemma/blob/main/packages/flutter_gemma/DESKTOP_SUPPORT.md) for details.
...
![flutter_gemma 1.0 modular architecture: a small core plus opt-in Inference / Embeddings / RAG families, each extensible with your own module](https://external-images.pub.dev/JNB1bS5Y8am1DnFModStgvtiXpCVSsoXBgNUaDz%2B%2Frc%3D/1783209600000/https%3A%2F%2Fraw.githubusercontent.com%2FDenisovAV%2Fflutter_gemma%2Fmain%2Fpackages%2Fflutter_gemma%2Fassets%2Farchitecture_1.0.png)
...
- ✅ **Every model / session / chat / embedding / RAG API is unchanged** — migrating is just adding packages + the initialize call. See **[MIGRATION.md](https://github.com/DenisovAV/flutter_gemma/blob/main/packages/flutter_gemma/MIGRATION.md)**.
...
See [CHANGELOG.md](https://github.com/DenisovAV/flutter_gemma/blob/main/packages/flutter_gemma/CHANGELOG.md) for the full release history.
...
- Model Family: Gemma 4 E2B
  - Best For: Next-gen multimodal chat — text, image, audio
  - Function Calling: ✅
  - Thinking Mode: ✅
  - Vision: ✅
...
- Model Family: Gemma3n
  - Best For: On-device multimodal chat and image analysis
  - Function Calling: ✅
  - Thinking Mode: ❌
  - Vision: ✅
  - Languages: Multilingual
  - Size: 3-6GB
- Model Family: FastVLM 0.5B
  - Best For: Fast vision-language inference
  - Function Calling: ❌
  - Thinking Mode: ❌
  - Vision: ✅
  - Languages: Multilingual
...
- Model Family: Phi-4 Mini
  - Best For: Advanced reasoning and instruction following
  - Function Calling: ✅
  - Thinking Mode: ❌
  - Vision: ❌
  - Languages: Multilingual
...
- Model Family: DeepSeek R1
  - Best For: High-performance reasoning and code generation
  - Function Calling: ✅
  - Thinking Mode: ✅
  - Vision: ❌
  - Languages: Multilingual
...
- Model Family: Qwen3 0.6B
  - Best For: Compact multilingual chat with function calling
  - Function Calling: ✅
  - Thinking Mode: ✅
  - Vision: ❌
  - Languages: Multilingual
...
- Model Family: Qwen 2.5
  - Best For: Strong multilingual chat and instruction following
  - Function Calling: ✅
  - Thinking Mode: ❌
  - Vision: ❌
  - Languages: Multilingual
  - Size: 0.5-1.6GB
- Model Family: Gemma 3 1B
  - Best For: Balanced and efficient text generation
  - Function Calling: ✅
  - Thinking Mode: ❌
  - Vision: ❌
  - Languages: Multilingual
...
- Model Family: Gemma 3 270M
  - Best For: Ideal for fine-tuning (LoRA) for specific tasks
  - Function Calling: ❌
  - Thinking Mode: ❌
  - Vision: ❌
  - Languages: Multilingual
  - Size: 0.3GB
- Model Family: FunctionGemma 270M
  - Best For: Specialized for function calling on-device
  - Function Calling: ✅
  - Thinking Mode: ❌
  - Vision: ❌
  - Languages: Multilingual
  - Size: 284MB
- Model Family: SmolLM 135M
  - Best For: Ultra-compact, resource-constrained devices
  - Function Calling: ❌
  - Thinking Mode: ❌
  - Vision: ❌
  - Languages: English
  - Size: 135MB
- Model Family: TranslateGemma 4B †
  - Best For: Single-shot 55-language translation
  - Function Calling: ❌
  - Thinking Mode: ❌
  - Vision: ❌
...
|On-device RAG on web                                                 |flutter_gemma_rag_sqlite|
    ...
    Core registers **no** engine by itself — you wire the packages you added in `FlutterGemma.initialize(...)` (see [Initialize Flutter Gemma](#initialize-flutter-gemma)).

2.  Run `flutter pub get` to install.


> **Migrating from 0.16.x (monolith)?** See **[MIGRATION.md](https://github.com/DenisovAV/flutter_gemma/blob/main/packages/flutter_gemma/MIGRATION.md)** — the only breaking change is adding the opt-in packages and the `initialize(...)` call; every model / session / RAG API is unchanged.
...
📚 **[Full Desktop Documentation →](https://github.com/DenisovAV/flutter_gemma/blob/main/packages/flutter_gemma/DESKTOP_SUPPORT.md)**
...
### 2\. Create and Use Model (Multiple Times) [#](#2-create-and-use-model-multiple-times)
...
> **`maxTokens` vs `maxOutputTokens` — don't confuse them.** `maxTokens` is the **context window**: the total budget shared by the input (system prompt + history + your message) **and** the generated reply — i.e. the KV-cache size. It is **not** the response length. `.litertlm` models require a context window of at least **1024**; passing a smaller `maxTokens` (e.g. `100`) used to crash with `DYNAMIC_UPDATE_SLICE` and is now clamped up to 1024 automatically (#318).
>
...
> (`maxOutputTokens` is honored on `.litertlm`; MediaPipe `.task` has no session-level output cap and ignores it.)
...
> ⚠️ **Concurrent contexts, serialized inference.** The sessions are logically independent, but **only one session generates at a time** — calling `generateResponse()` on a second session while another is still running blocks until the first finishes. Generation is _not_ parallel. This is intentional: parallel on-device inference would contend for the accelerator and risk OOM.

**Per-platform behavior** (transparent to your code — the API is identical):

- Path: .litertlm — native (Android/iOS/macOS/Windows/Linux)
  - How it works: Engine allows one live conversation; sessions multiplex — the active session's history is replayed on switch.
- Path: .litertlm — web (@litert-lm/core)
  - How it works: Separate conversations; generation still serialized.
- Path: .task — MediaPipe (Android/iOS)
  - How it works: N real LlmInferenceSession live at once (each with its own KV cache); generation serialized by a mutex.
- Path: .task — MediaPipe web
  - How it works: ❌ Not yet — openSession() throws UnsupportedError. Planned for a future release.
...
Use `uninstallModel()` to delete a model's metadata and files. When you remove the model that is currently **active**, also clear its persisted identity so it isn't auto-restored on the next app launch:
...
`clearActiveInferenceIdentity()` / `clearActiveEmbeddingIdentity()` wipe both the in-memory active spec and the SharedPreferences entry. Pair them with `uninstallModel()` only when the deleted model was the active one — otherwise the deleted model would be restored as active on the next launch.

### Handling download errors [#](#handling-download-errors)

`installModel(...).install()` throws a public `DownloadException` carrying a sealed `DownloadError`, so you can react to gated HuggingFace models (HTTP 401/403) without substring-matching error strings:
...
Each `DownloadError` exposes `toUserMessage()`, `toTitle()`, `isRetryable`, and `requiresUserAction` helpers for building UI.
...
- Parameter: inferenceEngines: [LiteRtLmEngine()]
  - Provided by: flutter_gemma_litertlm
  - Notes: .litertlm (mobile + desktop + web)
- Parameter: inferenceEngines: [MediaPipeEngine()]
  - Provided by: flutter_gemma_mediapipe
  - Notes: .task / .bin (mobile + web)
- Parameter: embeddingBackends: [LiteRtEmbeddingBackend()]
  - Provided by: flutter_gemma_embeddings
  - Notes: text embeddings
- Parameter: vectorStore: QdrantVectorStore()
  - Provided by: flutter_gemma_rag_qdrant
  - Notes: native RAG
- Parameter: vectorStore: SqliteVectorStore() / WebSqliteVectorStore()
  - Provided by: flutter_gemma_rag_sqlite
  - Notes: native / web RAG
...
- Level: GemmaLogLevel.none
  - What it prints (debug only): Nothing — fully silent.
- Level: GemmaLogLevel.info (default)
  - What it prints (debug only): Lifecycle, errors, diagnostics. No model output / prompts.
- Level: GemmaLogLevel.verbose
  - What it prints (debug only): Everything above plus model output, prompts, and conversation history.
...
- Source Type: NetworkSource
  - Platform: All
  - Progress: ✅ Detailed
  - Resume: ⚠️ Server-dependent
  - Authentication: ✅ Supported
  - Use Case: HuggingFace, CDNs, private servers
- Source Type: AssetSource
  - Platform: All
  - Progress: ⚠️ End only
  - Resume: ❌ No
  - Authentication: ❌ N/A
  - Use Case: Models bundled in app assets
- Source Type: BundledSource
  - Platform: All
  - Progress: ⚠️ End only
  - Resume: ❌ No
  - Authentication: ❌ N/A
  - Use Case: Native platform resources
- Source Type: FileSource
  - Platform: Native (no Web)
  - Progress: ⚠️ End only
  - Resume: ❌ No
  - Authentication: ❌ N/A
  - Use Case: User-selected files (file picker)
...
- Legacy API: urltomarkdowncodeblockplaceholder450.4083899142410614
  - Modern API: urltomarkdowncodeblockplaceholder460.9845630580681701
- Legacy API: urltomarkdowncodeblockplaceholder470.6921068605403129
  - Modern API: urltomarkdowncodeblockplaceholder480.8768086048496053

- Legacy API: urltomarkdowncodeblockplaceholder490.2725812292713361
  - Modern API: urltomarkdowncodeblockplaceholder500.617528585555972
...
### Model Creation and Inference [#](#model-creation-and-inference)
...
- Model: Gecko 64
  ...
  - Size: 110MB
  - Best For: Short queries, real-time search
  - Auth Required: ❌
- Model: Gecko 256
  - Parameters: 110M
  - Dimensions: 768D
...
- Model: Gecko 512
  ...
  - Size: 116MB
  - Best For: Medium context documents
  - Auth Required: ❌
- Model: EmbeddingGemma 256
  ...
  - Max Seq Length: 256 tokens
  - Size: 179MB
  - Best For: High accuracy, short context
  - Auth Required: ✅
- Model: EmbeddingGemma 512
  - Parameters: 300M
  - Dimensions: 768D
  - Max Seq Length: 512 tokens
  - Size: 179MB
  - Best For: High accuracy, medium context
  - Auth Required: ✅
- Model: EmbeddingGemma 1024
  - Parameters: 300M
  - Dimensions: 768D
  - Max Seq Length: 1024 tokens
  - Size: 183MB
  - Best For: Long documents, detailed content
  - Auth Required: ✅
- Model: EmbeddingGemma 2048
  - Parameters: 300M
  - Dimensions: 768D
...
**Benchmarks** comparing qdrant-edge to the legacy sqlite + local_hnsw backend across 5 platforms (5 000 documents, EmbeddingGemma 300M, 768-dim): see [example/integration_test/benchmarks/comparison.md](https://github.com/DenisovAV/flutter_gemma/blob/main/packages/flutter_gemma/example/integration_test/benchmarks/comparison.md).
...
- Feature: Text Generation
  ...
  - Web: ✅ Full
  - Desktop: ✅ Full
  - Notes: All models supported
- Feature: Image Input (Multimodal)
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ✅ Full
  - Notes: Verified on macOS Metal and Linux Vulkan (Gemma 4 + Gemma 3n)
- Feature: Audio Input
  - Android: ✅ Full
  - iOS: ✅ Full ¹
  - Web: ❌ Not supported
  - Desktop: ✅ .litertlm only
  - Notes: Gemma3n E2B/E4B + Gemma 4; iOS device-only; Desktop via FFI
- Feature: Function Calling
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ✅ Full
  - Notes: Gemma 4 native (SDK chat template)
- Feature: Thinking Mode
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ❌ Not supported
  - Desktop: ✅ Full
  - Notes: Gemma 4 / DeepSeek / Qwen3; not available on Web yet (MediaPipe .task web has no extraContext; .litertlm web is not verified)
- Feature: Stop Generation
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ✅ Full
  - Notes: Cancel mid-process
- Feature: GPU Acceleration
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ✅ Full
  - Notes: Metal/WebGPU/Vulkan/DX12
- Feature: NPU Acceleration
  - Android: ✅ Full
  - iOS: ❌ Not supported
  - Web: ❌ Not supported
  - Desktop: ✅ Windows
  - Notes: Android (.litertlm) + Windows Intel LunarLake/PantherLake
- Feature: CPU Backend
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ❌ Not supported
  - Desktop: ✅ Full
  - Notes: MediaPipe limitation
- Feature: Streaming Responses
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ✅ Full
  - Notes: Real-time generation
- Feature: LoRA Support
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ❌ Not supported
  - Notes: LiteRT-LM limitation
- Feature: Text Embeddings
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ✅ Full
  - Notes: EmbeddingGemma, Gecko
- Feature: VectorStore (RAG)
  - Android: ✅ qdrant-edge
  - iOS: ✅ qdrant-edge
  - Web: ✅ wa-sqlite (WASM)
  - Desktop: ✅ qdrant-edge
  - Notes: Semantic search + payload Filter (native)
...
- Feature: Asset Loading
  ...
  - Web: ✅ Full
  - Desktop: ❌ Not supported
  - Notes: Flutter assets N/A
- Feature: Bundled Resources
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ✅ Full
  - Desktop: ❌ Not supported
  - Notes: Native bundles only
- Feature: External Files (FileSource)
  - Android: ✅ Full
  - iOS: ✅ Full
  - Web: ❌ Not supported
  - Desktop: ✅ Full
  - Notes: No local FS on web

> **Web column note:** the **Web** ✅ marks above describe the MediaPipe `.task` web path (image input, function calling, etc.). **Thinking Mode is not supported on Web yet** — MediaPipe `.task` web has no `extraContext` hook, and the newer **web `.litertlm`** path (`@litert-lm/core`) is an early-preview subset (text-only; vision/audio/thinking not verified). See [Web `.litertlm` support & limitations](#web-litertlm-support--limitations).
...
Web `.litertlm` inference (added in 0.16.2) runs Gemma `.litertlm` models (verified on Gemma 4 E2B/E4B web variants) in the browser through the upstream [`@litert-lm/core`](https://www.npmjs.com/package/@litert-lm/core) package (WebGPU + WASM). It is an **early preview** and is intentionally a subset of the native `.litertlm` path. MediaPipe `.task` on web is unaffected and remains fully supported.
